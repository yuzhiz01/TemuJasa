...
<?php $__sections['title'] = 'Data Pesanan'; ?>
<?php $user = auth()->user(); ?>
...
<?php $__sections['page-title'] = 'Data Pesanan'; ?>
<?php $__sections['page-subtitle'] = 'Rekap seluruh pesanan pada platform'; ?>
...
<a href="<?php echo e(route('admin.pesanan')); ?>" class="sidebar-nav-item active"><i class="fa-solid fa-bag-shopping"></i><span>Data Pesanan</span></a>
...
<div class="dash-card">
    <p style="font-size:11px;color:#888;margin-bottom:14px;">
        Halaman rekapitulasi data pesanan. Gunakan halaman ini untuk memantau transaksi yang terjadi antara pelanggan dan penyedia jasa.
    </p>
